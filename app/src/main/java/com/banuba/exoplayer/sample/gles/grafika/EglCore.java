...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        Log.d(TAG, "EGL_CONTEXT_CLIENT_VERSION " + values[0]);
    }
    ...
    protected void finalize() throws Throwable {
        try {
            if (mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                ...
                Log.w(TAG, "finalize: mEGLDisplay != EGL_NO_DISPLAY in EglCore");
                release();
            }
        } finally {
            super.finalize();
    ...
    boolean makeCurrentResult(EGLSurface eglSurface) {
        if (mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            Log.d(TAG, "EGL_NO_DISPLAY");
        }
        return EGL14.eglMakeCurrent(mEGLDisplay, eglSurface, eglSurface, mEGLContext);
    }
